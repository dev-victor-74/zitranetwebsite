  ...
  return (
    <main className="w-full">
      <div
        ...
        className="w-full h-[50vh] md:h-[70vh] px-2 md:px-0 lg:h-[75vh] overflow-hidden bg-slate-300 relative flex flex-col items-center justify-center"
      >
        <div className="absolute top-0 w-full right-0 bg-black/50 p-[10px] md:p-0 flex items-center justify-center h-full">
          <div className="flex flex-col items-center justify-center gap-2 w-full md:w-[65%] lg:w-[55%] ">
            ...
            <p className="text-[13px] md:text-[15px] font-medium text-zinc-300/90 text-center">
      ...
      <div className="w-full flex flex-col gap-y-12 md:gap-y-16 lg:gap-y-20">
        <section className="mx-auto flex flex-col-reverse md:flex-row items-center w-full md:w-[94%] lg:w-[84%] px-[14px] md:px-1 justify-between gap-4 md:gap-8 mt-5 md:mt-10">
          <div className=" flex flex-col gap-y-3 md:w-[70%] lg:w-[80%]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[13px] md:text-[15px] text-justify font-medium text-neutral-900">
                ...
                actionable insights and tailored solutions.
              </p>
            </div>
          </div>
        ...
        <section className="mx-auto flex flex-col-reverse md:flex-row items-center w-full md:w-[94%] lg:w-[84%] px-[14px] md:px-1 justify-between gap-4 md:gap-8 mt-7 md:mt-14">
          <div className=" flex flex-col gap-2 w-full md:w-[70%] lg:w-[80%]">
            ...
            <div className="flex flex-col gap-2 gap-y-3 text-justify">
              <p className="text-[14px] md:text-[15px] font-bold text-zinc-800">
                We offer:
              </p>
