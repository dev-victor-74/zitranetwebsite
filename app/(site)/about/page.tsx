...
const Aboutpage = () => {
  return (
    <main className='w-full'>
        <div 
         style={{backgroundImage:"url(/home.jpg)", backgroundSize:"cover"}}
          className="w-full h-[40vh] md:h-[50vh] px-6 md:px-0 lg:h-[70vh] bg-no-repeat overflow-hidden bg-slate-300 relative flex flex-col items-center justify-center">
           <div className="absolute top-0 w-full right-0 bg-black/85 p-6 md:p-0 flex items-center justify-center h-full">
             <div className="flex flex-col items-center justify-center gap-2 w-full md:w-[65%] lg:w-[55%] ">
                 <h2 className='text-xl md:text-3xl tracking-wider font-bold md:font-extrabold text-zinc-200'>About Us</h2>
                 <p className='text-[15px] font-medium text-zinc-300/90 text-center'>
                    At Zitranet, we pride ourselves on using the latest advancements in artificial intelligence,
                    machine learning, and web technologies. Our chatbots are equipped with natural language
                    processing capabilities, enabling them to understand and respond to customer queries with
                    human-like precision. Our web development practices adhere to the highest standards, ensuring
                    your online presence is robust and secure. Additionally, our Salesforce administration services
                    leverage the full potential of the platform, providing you with tools to manage customer
        ...
        <AboutUnique
          ...
          imageClass=' h-[260px] sm:h-[300px] md:h-[400px] w-full md:w-[55%] lg:w-[55%] ring-2 ring-pink-300'
        ...
        />
         ...
         <div 
          ...
          className="w-full h-[40vh] md:h-[60vh] px-6 bg-no-repeat md:px-0 lg:h-[60vh] overflow-hidden bg-[#91073b] relative flex flex-col items-center justify-center">
            <div className="absolute top-0 w-full right-0 bg-black/85 flex p-6 md:p-0 items-center justify-center h-full">
             <div className="flex flex-col items-center justify-center gap-2 md:gap-2 w-full md:w-[65%] lg:w-[55%] ">
                 <h2 className='text-lg md:text-3xl tracking-wider font-bold md:font-extrabold text-zinc-200'>Our Vision</h2>
                 <p className='text-[15px] md:text-[15px] font-medium text-zinc-300 text-center'>
                  We envision a future where businesses can effortlessly engage with their customers through
                  intelligent, responsive, and intuitive technology solutions. By bridging the gap between
                  technology and human interaction, we aim to create a world where customer service is not just
                  efficient, but also personal and enjoyable.
                 </p>
              </div>
             </div>
        </div>
        <AboutUnique
          ...
          label='We Are Unique'
          imageClass='h-[260px] sm:h-[300px] md:h-[400px] w-full md:w-[55%] lg:w-[48%] ring-2 ring-pink-300'
        ...
        <AboutUnique
          ...
          imageClass='h-[260px] md:h-[400px] w-full sm:h-[300px] md:w-[60%] ring-2 ring-pink-300'
        />
    </main>
  )
}
