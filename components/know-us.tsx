        ...
        <div className="w-full flex flex-col-reverse md:flex-row items-center justify-between gap-7">
             ...
             <div className="w-full flex flex-col items-center md:items-start gap-2">
                <h2 className='text-xl md:text-3xl font-extrabold text-zinc-800'>
                  About Us</h2>
                  <p
                    className='text-[15px] md:text-[16px] font-medium text-neutral-800 text-center md:text-justify'
                  >
                    At Zitranet, we specialize in revolutionizing various industries through innovative technology
                    solutions. Our mission is to enhance customer experiences, streamline operations, and drive
                    business growth by providing cutting-edge chatbot technology, expert consultation, reliable
                    maintenance, web development, and Salesforce administration services tailored specifically to
                    your business needs.
