...
const AboutUnique = ({
  ...
  return (
    <div className="w-full rounded-[2px] py-8 mt-3 px-1">
      <div
        className={cn(
          "w-full md:w-[94%] lg:w-[85%] px-[10px] mx-auto flex flex-col justify-between items-center",
          className
        )}
      >
        <div
        ...
        <div className="w-full flex flex-col gap-4 mx-auto md:mx-0">
          ...
          <div className="text-[13px] md:text-[15px] font-medium text-justify text-neutral-900 flex flex-col gap-3">
