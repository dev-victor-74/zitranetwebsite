...
const handleSubmit=async(event: any)=>{
  ...
  return (
    <div
     className='w-full bg-[#91073b] rounded-[2px] p-3 mt-8'
    >
        <div className="w-full md:w-[90%] lg:w-[80%] px-6 mx-auto flex items-center justify-between gap-4">
             ...
             <div className="w-full flex flex-col justify-center gap-2 mx-auto md:mx-0">
                 <h3 className='text-xl md:text-2xl font-bold md:font-extrabold tracking-wide text-center md:text-start text-zinc-200 ml-1'>Contact Us</h3>
                 <form ref={formRef} onSubmit={handleSubmit} className='flex flex-col gap-4 px-2 py-2 rounded-sm'>
                    ...
                    <div className="w-full flex flex-col gap-1">
                        ...
                        placeholder='Your email' className='w-full p-2 rounded-[2px] outline-none focus:outline-none focus:ring-1 focus:ring-pink-400 py-3 ring-1 text-sm font-semibold text-zinc-200 ring-slate-200 bg-inherit' />
                    </div>  
                     <div className="w-full flex flex-col gap-1">
