...
const ContactInfo = () => {
  return (
    <div className="w-full flex items-center justify-center px-2 mt-2 md:mt-0">
      <div className="w-full md:w-[95%] lg:w-[85%] flex flex-col md:flex-row items-start md:items-center md:justify-center gap-2">
        ...
        <a
          ...
          className="flex items-center gap-2 w-full md:w-[25%] lg:w-[20%]"
        >
          <div className="flex items-center justify-center bg-rose-800 p-[6px] rounded-full">
        ...
        <a
          ...
          className="flex items-center gap-2 w-full md:w-[35%] "
        >
          <div className="flex items-center justify-center bg-rose-800 p-[6px] rounded-full">
